...
List<GoRoute> authRoutes() => [
  ...
  GoRoute(path: VerificationScreen.routeName, builder: (context, state) => VerificationScreen(email: (state.extra as String?) ?? '')),
  GoRoute(path: '/verify', builder: (context, state) => VerificationScreen(email: (state.extra as String?) ?? '')),
