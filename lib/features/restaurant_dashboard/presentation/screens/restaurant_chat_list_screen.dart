...
class RestaurantChatListScreen extends StatefulWidget {
  ...
  @override
  State<RestaurantChatListScreen> createState() => _RestaurantChatListScreenState();
}
...
class _RestaurantChatListScreenState extends State<RestaurantChatListScreen> {
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'NGOs will contact you about donations',
                            style: TextStyle(
                              fontSize: 14,
  ...
  Widget _buildConversationTile(
    ...
    // For restaurants, show NGO name instead of restaurant name
    final displayName = conversation.restaurantName;

    return InkWell(
      onTap: () {
        context.push(
          '/restaurant/chat/${conversation.id}',
          extra: {
