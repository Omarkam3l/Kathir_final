-- ============================================
-- Migration 001: Fix Order Creation & NGO Query Issues
-- Date: 2026-02-10
-- Author: System Fix
-- ============================================
-- PROBLEMS FIXED:
-- 1. Order creation fails with "column oi.subtotal does not exist"
-- 2. NGO dropdown causes "stack depth limit exceeded" error
-- 3. Meal price validation (0.00 is correct for free meals)
-- ============================================
