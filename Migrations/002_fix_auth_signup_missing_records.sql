-- ============================================
-- Migration 002: Fix Authentication Signup - Missing NGO/Restaurant Records
-- Date: 2026-02-10
-- Author: System Fix
-- ============================================
-- PROBLEM FIXED:
-- When users sign up as NGO/Restaurant, the trigger creates the profile
-- but sometimes fails to create the NGO/restaurant record. This causes
-- "record not found" errors when uploading legal documents.
--
-- SOLUTION:
-- Update the append functions to auto-create missing records if they
-- don't exist when legal documents are uploaded.
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE '1. append_ngo_legal_doc() - Auto-creates missing NGO records';
  RAISE NOTICE '2. append_restaurant_legal_doc() - Auto-creates missing restaurant records';
  RAISE NOTICE '';
  RAISE NOTICE 'Users can now upload legal documents without errors';
  RAISE NOTICE '========================================';
END $$;
